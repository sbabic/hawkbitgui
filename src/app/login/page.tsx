        ...
        <div className={`${styles.page}`}>
            <div className={`${styles.logoSection}`}>
                ...
                <div className={styles.policiesSection}>
                    <div>
                        <a href={'https://www.eclipse.org/legal/privacy/'}>
                            Privacy Policy
                        </a>
                        <p>|</p>
                        <a href={'https://www.eclipse.org/legal/terms-of-use/'}>
                            Terms of Use
                        </a>
                        <p>|</p>
                        <a href={'https://www.eclipse.org/legal/copyright/'}>
                            Copyright Agent
                        </a>
                    </div>
                    <div>
                        ...
                        <p>|</p>
                        <a href={'https://www.eclipse.org/legal/'}>
                            Legal Resources
                        </a>
                    </div>
                    <div>
                        <p>
                            Copyright © Eclipse Foundation, Inc. All Rights
                            Reserved.
                        </p>
                    </div>
                </div>
